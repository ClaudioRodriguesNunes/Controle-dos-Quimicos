...
<body class="p-4">
  <div class="container">
    ...
    <a href="ProdutoController.php?action=new" class="btn btn-success mb-3">Novo Produto</a>
    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="ProdutoController.php?action=edit&id=<?= $p['id_produto'] ?>"
               class="btn btn-sm btn-primary">Editar</a>
            <a href="ProdutoController.php?action=delete&id=<?= $p['id_produto'] ?>"
