...
<body class="p-4">
  <div class="container">
    <h1 class="mb-4">Cadastrar Supervisor</h1>

    <?php if (!empty($error)): ?>
      <div class="alert alert-danger"><?= htmlspecialchars($error) ?></div>
    <?php endif; ?>

    <form action="SupervisorController.php?action=new" method="post">
      <div class="mb-3">
      ...
      <a href="SupervisorController.php?action=list" class="btn btn-secondary">
        Cancelar
      </a>
    </form>
  </div>
